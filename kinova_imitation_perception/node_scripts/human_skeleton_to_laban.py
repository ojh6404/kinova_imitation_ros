...
import kinova_imitation_common_msgs.msg
...
class HumanSkeletonToLaban(ConnectionBasedTransport):
    ...
    def __init__(self):
        ...
        self.pose_pub = self.advertise(
            '~output/skeleton',
            kinova_imitation_common_msgs.msg.HumanSkeletonArray, queue_size=1)
    ...
    def _cb(self, skeleton_msg):
        skeleton_with_laban_msg = kinova_imitation_common_msgs.msg.HumanSkeletonArray(
            header=skeleton_msg.header,
            human_ids=skeleton_msg.human_ids)
        for skeleton in skeleton_msg.skeletons:
            limb_to_pose = {}
            out_skeleton_msg = kinova_imitation_common_msgs.msg.HumanSkeleton(
