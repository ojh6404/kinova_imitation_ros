...
class FullArmMovement:
    def __init__(self):
        try:
            rospy.init_node('full_arm_movement')
    ...
    def send_joint_angles(self, angle_vector):
        self.last_action_notif_type = None
    ...
    def main(self):
        ...
        if success:
            ...
            # success &= self.move_to_reset_pose()
            #*******************************************************************************
            ...
            # rospy.loginfo("testing send joint angles")
            ...
            success &= self.send_joint_angles(angle_vector=[0.] * 7)
